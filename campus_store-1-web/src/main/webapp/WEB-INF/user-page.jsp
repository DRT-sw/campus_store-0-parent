...
<script type="text/javascript">
	...
	function pageselectCallback(pageIndex, jq) {
		...
		window.location.href = "user/query/for/search.html?pageNum="+pageNum+"&keyword=${param.keyword}";
		...
		$.ajax({
			...
			"success" : function(response) {
				...
				if (result == "SUCCESS") {//${requestScope['PAGE-INFO'].pageNum}当前页
					window.location.href = "user/query/for/search.html?pageNum=${requestScope['PAGE-INFO'].pageNum}&keyword=${param.keyword}";
				}
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form action="user/query/for/search.html" class="form-inline"
						...
						<a href="user/to/add/page.html" class="btn btn-primary"
								...
								<tbody>
									...
									<c:if test="${!empty requestScope['PAGE-INFO'].list }">
										<c:forEach items="${requestScope['PAGE-INFO'].list }"
											var="user" varStatus="myStatus">
											<tr>
												<td>${myStatus.count }</td>
												<td><input adminId="${user.id }" class="itemBox"
													type="checkbox"></td>
												...
												<td>
													...
													href="user/to/edit/page.html?userId=${user.id }&pageNum=${requestScope['PAGE-INFO'].pageNum}"
													class="btn btn-primary btn-xs"><i
														class=" glyphicon glyphicon-pencil"></i></a>
													<button adminId="${user.id }" type="button"
