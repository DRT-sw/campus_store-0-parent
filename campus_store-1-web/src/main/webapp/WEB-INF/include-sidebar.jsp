	...
	<div class="tree">
		<ul style="padding-left: 0px;" class="list-group">
			...
			<li class="list-group-item tree-closed"><span><i
					class="glyphicon glyphicon glyphicon-tasks"></i> 账号管理 <span
					class="badge" style="float: right">2</span></span>
				<ul style="margin-top: 10px; display: none;">
					<li style="height: 30px;"><a
						href="admin/query/for/search.html"> <i
							class="glyphicon glyphicon-user"></i> 商家（卖家）账号管理
					</a></li>
					<li style="height: 30px;"><a href="user/query/for/search.html">
							<i class="glyphicon glyphicon-king"></i> 用户（买家）账号管理
						</a>
					</li>
			...
			<li class="list-group-item tree-closed"><span><i
					class="glyphicon glyphicon-ok"></i> 商品<span class="badge"
					style="float: right">1</span></span>
				<ul style="margin-top: 10px; display: none;">
					<li style="height: 30px;"><a href="goods/query/for/search"><i
							class="glyphicon glyphicon-check"></i> 商品管理</a></li>
